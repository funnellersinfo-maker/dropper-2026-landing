...
export default function Testimonials() {
  ...
  const testimonials = [
    ...
    { name: "Juan Pérez", role: "Empresario E-commerce", text: "Pago una sola vez y tengo infraestructura vitalicia. Es el mejor ROI que he hecho en mi vida.", image: "https://i.pravatar.cc/100?u=6" },
  ];
